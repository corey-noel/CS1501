...
public class SecureChatServer {
	...
	private class UserThread extends Thread
	{
		 ...
		 public void run()
		 {
		 	System.out.printf("New user: %s, %d\n", myName, myId);
			  boolean ok = true;
			  while (ok)
			  {
					String newMsg = null;
					...
					try {
						 ...
						 if (newBytes == null || newMsg.equals("CLIENT CLOSING")) {
						 		System.out.println("Clent quit: " + myName);
							 	ok = false;
						 } else {
					...
					{
						ok = false;
						System.out.println("Client caused exception: " + myName);
						e.printStackTrace();
					}
			  }
			  System.out.println("Removing client " + myName);
